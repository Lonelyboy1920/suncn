package com.gavin.giframe.interceptor.logging;
...
public class LoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (subtype != null && (subtype.contains("json")
            ...
            String bodyString;
            if (builder.mIsSimpleChinese) {
                bodyString = Printer.getJsonString(responseBody.string());
            } else {
                JChineseConvertor jChineseConvertor = JChineseConvertor.getInstance();
                String s = jChineseConvertor.s2t(responseBody.string());
                bodyString = Printer.getJsonString(s);
            }
    ...
    public static class Builder {
         ...
         * 是否是简体中文
         *
         * @param isSimpleChinase
         * @return
         */
        public Builder isSimpleChinese(boolean isSimpleChinase) {
            this.mIsSimpleChinese = isSimpleChinase;
            return this;
        }
    }
