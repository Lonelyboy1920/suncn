 ...
 */
public class GIActivityStack {
    private static Stack<Activity> activityStack;
    private static Stack<Fragment> fragmentStack;
    private static GIActivityStack instance;

    private GIActivityStack() {
    }

    /**
     * 单例模式
     *
     * @return GIActivityStack
     */
    public static GIActivityStack getInstance() {
        if (instance == null) {
            instance = new GIActivityStack();
        }
        return instance;
    }
