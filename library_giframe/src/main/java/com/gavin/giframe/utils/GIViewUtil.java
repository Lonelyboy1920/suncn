 ...
 * 4、提供多个常用的 View 相关工具方法，如对 View 设置单个方向的 padding、判断 ListView 是否已经滚动到底部等等。
 * 5、修复使ScrollView嵌套的ListView / GridView / WebView / RecyclerView处于顶部的问题。
 * 6、测量View 和 强制获取View大小
 */

public class GIViewUtil {
    ...
    public static void playViewBackgroundAnimation(final View v, @ColorInt int startColor, @ColorInt int endColor, long duration, int repeatCount, int setAnimTagId, final Runnable endAction) {
        ...
        GIViewUtil.setBackgroundColorKeepPadding(v, startColor);
        ...
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                GIViewUtil.setBackgroundColorKeepPadding(v, (Integer) animation.getAnimatedValue());
            }
        });
        if (setAnimTagId != 0) {
    ...
    /**
     * 修复使ScrollView嵌套的ListView / GridView / WebView / RecyclerView处于顶部的问题。
     *
