 ...
 * 日志打印类
 */
public class GILogUtil {
    private static boolean IS_SHOW_LOG = false;
    private static boolean IS_SHOW_ACTIVITY_STATE = true;
    ...
    public static void log_state(String packName, String state) {
        if (IS_SHOW_ACTIVITY_STATE) printLog(D, "GILogUtil_State", packName + state);
    }
