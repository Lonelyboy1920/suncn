...
public class QDRecordedButton extends View {
    ...
    public QDRecordedButton(Context context) {
        super(context);
        init();
    }

    public QDRecordedButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public QDRecordedButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        dp5 = (int) getResources().getDimension(R.dimen.view_dp);
        colorGray = getResources().getColor(R.color.gray);
        colorBlue = getResources().getColor(R.color.colorDefaultUserPhoto1);
    ...
    private void startAnim(float start, float end){
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                radius2 = measuredWidth * (zoom - 0) / 2.5f;
                invalidate();
            }
        });
        va.start();
