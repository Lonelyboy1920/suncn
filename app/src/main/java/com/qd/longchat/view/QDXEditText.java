 ...
 * @creatTime 2018/5/14 上午9:31
 */

public class QDXEditText extends AppCompatEditText {
    ...
    public QDXEditText(Context context) {
        this(context, null);
    }

    public QDXEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public QDXEditText(Context context, AttributeSet attrs, int defStyleAttr) {
