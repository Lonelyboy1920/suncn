 ...
 * @creatTime 2018/6/8 下午3:56
 */
public class QDDatePickView extends View {
    ...
    public QDDatePickView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.view_head_bg));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Paint.Style.FILL);
        nPaint.setTextAlign(Paint.Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.color4));
    }
