 ...
 * @creatTime 2018/6/8 下午3:55
 */
public class QDDateSelectView {
    /**
     * 定义结果回调接口
     */
    ...
    private QDDatePickView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    public QDDateSelectView(Context context, ResultHandler resultHandler, String startDate, String endDate) {
...
//                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd", Locale.CHINA);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new QDDatePickView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new QDDatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new QDDatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new QDDatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new QDDatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
    ...
    public void show(String time) {
        if (canAccess) {
            if (isValidDate(time, "yyyy-MM-dd") || isValidDate(time, "yyyy-MM-dd HH:mm")) {
