...
public class QDCopyPopupList {
    ...
    /**
     * {@link QDCopyPopupList#init(Context, View, List, OnPopupListClickListener)} method make QDCopyPopupList restored
...
//        int xOffset = mAnchorView.getWidth() / 2 - mPopupWindow.getWidth() / 2;
//        int yOffset = mAnchorView.getHeight() + mPopupWindow.getHeight();
//        mPopupWindow.showAsDropDown(mAnchorView, xOffset, 0 - yOffset);
