 ...
 * @creatTime 2018/4/10 下午4:39
 */

public class QDSideBar extends View {
    ...
    /**
     * if true, the {@link OnSelectIndexItemListener#onSelectIndexItem(int, String, int)}
    ...
    public QDSideBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QDSideBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mStartTouchingArea.contains(eventX, eventY)) {
                    ...
                    if (!mLazyRespond && onSelectIndexItemListener != null) {
                        onSelectIndexItemListener.onSelectIndexItem(mCurrentIndex, mIndexItems[mCurrentIndex], MotionEvent.ACTION_DOWN);
                    }
                    invalidate();
                    return true;
                } else {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mStartTouching && !mLazyRespond && onSelectIndexItemListener != null) {
                    onSelectIndexItemListener.onSelectIndexItem(mCurrentIndex, mIndexItems[mCurrentIndex], MotionEvent.ACTION_MOVE);
                }
                invalidate();
                return true;
            ...
            case MotionEvent.ACTION_CANCEL:
                if (!mLazyRespond && onSelectIndexItemListener != null) {
                    onSelectIndexItemListener.onSelectIndexItem(mCurrentIndex, mIndexItems[mCurrentIndex], MotionEvent.ACTION_UP);
                }
                mCurrentIndex = -1;
    ...
    public void setIndexItems(List<String> indexItems) {
        mIndexItems = indexItems.toArray(new String[]{});
        requestLayout();
    }
    ...
    public interface OnSelectIndexItemListener {
        void onSelectIndexItem(int index, String content, int action);
    }
}
