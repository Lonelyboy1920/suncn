 ...
 * @creatTime 2018/6/9 下午3:50
 */
public class QDTestActivity extends QDBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextureView = findViewById(R.id.test);
        mCaptureBtn = findViewById(R.id.btn1);
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                    Toast.makeText(QDTestActivity.this, "Camera configuration change", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
