...
import com.suncn.ihold_zxztc.adapter.RideArrangeListAdapter;
...
public class RideArrangeListActivity extends BaseActivity {
    ...
    private ArrayList<RideArrangeListAdapter> adapters;
    ...
    private void getListData() {
        ...
        doRequestNormal(ApiManager.getInstance().CarArrangementServlet(textParamMap), 1);
    }
        ...
        try {
            switch (what) {
                case 0:
                    ...
                    break;
                case 1:
                    RideArrangeListBean hyrcListBean = (RideArrangeListBean) object;
                    View view = myViews.get(currentIndex);
                    RecyclerView easyRecyclerView = view.findViewById(R.id.recyclerView);
                    RideArrangeListAdapter adapter = adapters.get(currentIndex);
                    if (adapter == null) {
                        adapter = new RideArrangeListAdapter(activity);
    ...
    private void initAddView() {
        ...
        RideArrangeListAdapter adapter = new RideArrangeListAdapter(activity);
