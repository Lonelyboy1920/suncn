...
public class RadarView extends View {
    ...
    private ArrayList<Double> data = new ArrayList<>();  //各维度值
    //private float maxValue = 5;             //数据最大值
    private float maxValue = 1;             //数据最大值
    private Paint mainPaint;                //雷达区画笔
    private Paint innerValuePaint;               //数据区画笔
    private Paint textPaint;                //文本画笔
    private Paint outerValuePaint;                //雷达区边框画笔
    private float circleRadius = 2f;                //圆点半径
    ...
    public RadarView(Context context, AttributeSet attrs, int count) {
