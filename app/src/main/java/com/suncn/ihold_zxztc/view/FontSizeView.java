 ...
 * PackageName:com.suncn.ihold_zxztc.view
 * Desc:
 */
public class FontSizeView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initDefault
        defaultLineWidth = GIDensityUtil.dip2px(context, 2);
        defaultCircleRadius = GIDensityUtil.dip2px(context, 35);
        lineWidth = GIDensityUtil.dip2px(context, 1);
...
//        mTextPaint.setStrokeWidth(DensityUtils.dp2px(context, 1));
        mTextPaint.setTextSize(GIDensityUtil.dip2px(context, smallSize));
        textScaleX = mTextPaint.measureText("T");
        //文字画笔
        ...
        mText1Paint.setTextSize(GIDensityUtil.dip2px(context, bigSize));
        text1ScaleX = mText1Paint.measureText("T");
        ...
        mText2Paint.setTextSize(GIDensityUtil.dip2px(context, standerSize));
        ...
        mCirclePaint.setShadowLayer(2, 0, 0, Color.parseColor("#333333"));
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        //画字
        canvas.drawText("T", points.get(0).x - textScaleX / 2, height / 2 - 50, mTextPaint);

        //画字
        canvas.drawText("标准", points.get(1).x - text2ScaleX / 2, height / 2 - 50, mText2Paint);

        //画字
        canvas.drawText("T", points.get(points.size() - 1).x - text1ScaleX / 2, height / 2 - 50, mText1Paint);
        ...
        // 实体圆
        canvas.drawCircle(currentX, circleY, circleRadius - 1f, mCirclePaint);
    }
