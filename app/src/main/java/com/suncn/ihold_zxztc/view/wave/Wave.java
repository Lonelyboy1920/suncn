package com.suncn.ihold_zxztc.view.wave;
...
class Wave extends View {
    ...
    private final int WAVE_HEIGHT_MIDDLE = 35;
    private final int WAVE_HEIGHT_LITTLE = 30;
    private final int WAVE_HEIGHT_OTHER = 25;

    private final float WAVE_LENGTH_MULTIPLE_LARGE = 1.1f;
    private final float WAVE_LENGTH_MULTIPLE_MIDDLE = 0.9f;
    private final float WAVE_LENGTH_MULTIPLE_LITTLE = 0.7f;
    private final float WAVE_LENGTH_MULTIPLE_OTHER = 0.5f;
...
//        canvas.drawPath(mBlowWavePath, mBlowWavePaint);
    ...
    private float getWaveMultiple(int size) {
        switch (size) {
            ...
            case WaveView.OTHER:
                return WAVE_LENGTH_MULTIPLE_OTHER;
        }
        return 0;
    }
