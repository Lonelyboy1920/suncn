package com.suncn.ihold_zxztc.view.chat;
...
public class IndicatorView extends LinearLayout {
    ...
    public IndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        pointSize = GIDensityUtil.dip2px(context, size);
        marginLeft = GIDensityUtil.dip2px(context, marginSize);
    }
    ...
    public void initIndicator(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                v.setBackgroundResource(R.drawable.shape_circle_white);
            } else {
                v.setBackgroundResource(R.drawable.shape_circle_gary);
            }
            mImageViews.add(v);
            this.addView(v);
        }
    ...
    public void playByStartPointToNext(int startPosition, int nextPosition) {
        ...
        ViewNext.setBackgroundResource(R.drawable.shape_circle_white);
        ViewStrat.setBackgroundResource(R.drawable.shape_circle_gary);
    }
