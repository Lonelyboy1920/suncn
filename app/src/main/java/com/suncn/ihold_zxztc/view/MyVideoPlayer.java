...
public class MyVideoPlayer extends JzvdStd {
    public boolean isCanShowTools = true; // 点击视频是否显示操作按钮组

    public void setCanShowTools(boolean canShowTools) {
        isCanShowTools = canShowTools;
    }
...
//    }
    ...
    public void onStateAutoComplete() {
        ...
        if (videoStateListener != null) {
            videoStateListener.onStateComplete();
        }
