 ...
 * 相似社情民意adapter
 */
public class SimilarOpinionListAdapter extends BaseQuickAdapter<SimilarProposalListBean.SimilarProposal, SimilarOpinionListAdapter.ViewHolder> {
    private Context context;


    public SimilarOpinionListAdapter(Context context) {
    ...
    protected void convert(@NotNull ViewHolder viewHolder, SimilarProposalListBean.SimilarProposal similarProposal) {
        ...
        viewHolder.content_TextView.setText(context.getString(R.string.string_opinion) + "：" + similarProposal.getStrDestSourceName());
